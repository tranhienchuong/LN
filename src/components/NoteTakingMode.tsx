...
export function NoteTakingMode({ lesson, onAddVocabulary, onToggleUnknownWord }: NoteTakingModeProps) {
    ...
    <section className="mode-grid">
      <div className="surface mode-panel">
        <div className="section-heading">
          ...
          <button className="primary-button" onClick={() => setShowComparison(true)}>
            <FileText size={18} />
            Compare notes
          </button>
        </div>
